...
public class Burbujas implements Actions {
    ...
    public void pintar(Graphics2D g2) {
        for (int i = 0; i < elementos.size(); i++) {
            g2.drawOval(elementos.get(i).getXx(), elementos.get(i).getYy(), elementos.get(i).getRadio(), elementos.get(i).getRadio());
            // Imagen
            g2.drawImage(imagen, elementos.get(i).getXx(), elementos.get(i).getYy(), elementos.get(i).getRadio(), elementos.get(i).getRadio(), null);
            
            if( i == 0) {
                g2.setColor(new Color(255, 255, 255));
                g2.drawOval(elementos.get(i).getXx(), elementos.get(i).getYy(), elementos.get(i).getRadio(), elementos.get(i).getRadio());
                g2.drawLine(elementos.get(i).getCx(), elementos.get(i).getCy(), elementos.get(elementos.size() - 1).getCx(), elementos.get(elementos.size() - 1).getCy());
                g2.setColor(new Color(0, 0, 0));
            }
            else if(i < elementos.size() - 1) {
                g2.drawLine(elementos.get(i).getCx(), elementos.get(i).getCy(), elementos.get(i + 1).getCx(), elementos.get(i + 1).getCy());
            }
        }
    }
